...
select clients.id, first_name, last_name, email, account_no, balance  from clients left join accounts on accounts.client_id =  clients.id;

select account_no, client_id, account_types.name from accounts left join account_types on accounts."type" = account_types.id;
...
create view v_clients_accounts as select clients.id, first_name, last_name, email, account_no, balance  from clients left join accounts on accounts.client_id =  clients.id;

create view v_accounts_types as select account_no, client_id, account_types.name from accounts left join account_types on accounts."type" = account_types.id;
